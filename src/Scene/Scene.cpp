...
void Scene::BuildDemo(int demoIndex, Mesh& characterMesh, Mesh& planeMesh, bool externalCharacterLoaded)
{
    ...
    floor.material.baseColor = demoIndex == 0 ? XMFLOAT4(0.58f, 0.74f, 0.74f, 1.0f) : (demoIndex == 1 ? XMFLOAT4(0.58f, 0.70f, 0.76f, 1.0f) : XMFLOAT4(0.52f, 0.72f, 0.66f, 1.0f));
    ...
    character.name = demoIndex == 0 ? "Basic Lighting Character" : (demoIndex == 1 ? "Toon Character" : "Dissolve Character");
    ...
    character.material.ambientColor = demoIndex == 0 ? XMFLOAT4(0.13f, 0.15f, 0.19f, 1.0f) : (demoIndex == 1 ? XMFLOAT4(0.20f, 0.16f, 0.24f, 1.0f) : XMFLOAT4(0.10f, 0.08f, 0.16f, 1.0f));
    character.material.diffuseIntensity = 1.0f;
    character.material.specularIntensity = demoIndex == 0 ? 0.24f : (demoIndex == 1 ? 0.10f : 0.18f);
